...
**Hello Microverse** is a basic basic introductory project that illustrates the creation of repositories and simple HTML and CSS files. The project also illustrates the integration of Linter capabilities and GitHub flow.

## 🛠 Built With <a name="built-with"></a>

### Tech Stack <a name="tech-stack"></a>

The project was mainly built with HTML and CSS. It is implemented a simple web design interface that shows the use of colors with test in web development.
...
```sh
  - cd my-folder
  - git clone git@github.com:Kanyorok/Module1-Hello_World.git
  - cd Module1-Hello_World
```
### Install
...
- [ ] **[- Add Homepage primary menu.]**
- [ ] **[- Add landing page image.]**
- [ ] **[- Make site responsive to different devices.]**
